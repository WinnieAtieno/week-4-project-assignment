        ...
        breedsToDisplay.forEach(breed => {
            let breedHtml = `
                <div class="card">
                    ...
                    ${currentCategory === 'breed' ? `<h2>${breed.name}</h2>` : `
            ...
            `;
            showContainer.innerHTML += breedHtml;
        });
    ...
    function addToFavorite() {
        ...
        btnsArr.forEach(el => {
            el.addEventListener('click', (e) => {
                ...
                const name = card.querySelector('h2') ? card.querySelector('h2').textContent : card.querySelector('.card-description').textContent;
                const description = card.querySelector('.card-description') ? card.querySelector('.card-description').textContent : 'No description available';
                ...
                if (isActive) {
                    ...
                    e.target.style.backgroundColor = 'purple'; // Change button color to purple
                } else {
...
// Call the initializeApp function when the DOM content is fully loaded
